...
class User: Codable {
    ...
    init(success: Int, errorMessage: String, message: Message, data: [JSONAny]) {
...
extension User {
    convenience init(data: Data) throws {
        ...
        self.init(success: me.success, errorMessage: me.errorMessage, message: me.message, data: me.data)
    }
...
// To read values from URLs:
//
//   let task = URLSession.shared.messageTask(with: url) { message, response, error in
...
class Message: Codable {
    ...
    var side: Int? = 2//Side.left
    
    init(chatBotName: String, chatBotID: Int, message: String, emotion: String, side:Int) {
...
extension Message {
    convenience init(data: Data) throws {
        ...
        self.init(chatBotName: me.chatBotName, chatBotID: me.chatBotID, message: me.message, emotion: me.emotion, side:2)
    }
    ...
    func with(
        chatBotName: String? = nil,
        chatBotID: Int? = nil,
        message: String? = nil,
        emotion: String? = nil
    ) -> Message {
        return Message(
            chatBotName: chatBotName ?? self.chatBotName,
            chatBotID: chatBotID ?? self.chatBotID,
            message: message ?? self.message,
